...
const COPY = {
  en: {
    ...
    whatBody: "Measures traffic without depending on consent: no cookies, no consent banner, fully GDPR-compliant. You finally see what GA4 leaves behind.",
  ...
  es: {
    ...
    whatBody: "Mide el tráfico sin depender del consentimiento: sin cookies, sin banner, totalmente RGPD-compliant. Por fin ves lo que GA4 deja atrás.",
