...
const ITEMS = [
  ...
  },
  {
    ...
    a: "5 to 30 minutes to install, depending on the platform. First data from the first hour. Our team handles full onboarding and configures goals, funnels and reports in week one.",
  },
];
