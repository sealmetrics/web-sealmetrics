  ...
  const data: Record<VerticalKey, Record<Locale, Omit<VerticalPageData, "locale">>> = {
    ...
    dpo: {
      en: {
        ...
        outcomes: [
          ...
          { n: "0", label: "Sub-processors outside EU", detail: "In the visitor-data path. Check the list in Annex 3 of the DPA." },
        ],
        faqs: [
      ...
      es: {
        ...
        outcomes: [
          ...
          { n: "0", label: "Sub-procesadores fuera UE", detail: "En la ruta del dato de visitante. Consulta la lista en el Anexo 3 del DPA." },
        ],
        faqs: [
    ...
    media: {
      en: {
        ...
        lede: "Your audience runs ad blockers at 50%+ rates. Every analytics tool pretends it doesn't happen. Served from your own subdomain, Sealmetrics stops looking like third-party analytics to the lists ad blockers work from.",
        pains: [
      ...
      es: {
        ...
        lede: "Tu audiencia corre ad blockers a tasas del 50%+. Toda analítica finge que no pasa. Servido desde tu propio subdominio, Sealmetrics deja de parecer analítica third-party para las listas con las que trabajan los ad blockers.",
        pains: [
        ...
        faqs: [
          { q: "¿Sealmetrics realmente funciona con audiencias que usan ad blockers?", a: "Sí, cuando el tracker se sirve desde un subdominio de tu propio dominio. uBlock, AdGuard y los shields de Brave trabajan sobre todo con listas de dominios de tracking third-party conocidos, y el ITP de Safari ataca el tracking entre sitios, así que una petición first-party tiene muchas menos probabilidades de bloquearse. La instalación por defecto carga desde t.sealmetrics.com, que una lista sí puede incluir: con una audiencia que bloquea anuncios, configura el subdominio first-party." },
