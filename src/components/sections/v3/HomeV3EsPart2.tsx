...
export function ComparatorGA4Es() {
  const rows: { cap: string; ga: string; seal: string; icoGa: "no" | "partial"; icoSeal: "yes" }[] = [
    ...
    { cap: "Banner de consentimiento", ga: "Obligatorio en UE · el 40–60% del tráfico no acepta cookies (nuestra experiencia con clientes)", seal: "No requerido · sin penalización de rebote", icoGa: "no", icoSeal: "yes" },
