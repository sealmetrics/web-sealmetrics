...
export const bigqueryEs: ProblemLandingContent = {
  ...
  faq: [
    ...
    { question: "¿En qué se diferencia de la exportación de GA4 a BigQuery?", answer: "La exportación de GA4 es a nivel de evento y contiene lo que GA4 recogió: dato condicionado por el consentimiento, sin los usuarios modelados de Consent Mode, y en propiedades estándar hasta 1 millón de eventos al día. La de Sealmetrics contiene agregados medidos sin pérdida por consentimiento, ya organizados por canal y campaña, sin filas por usuario." },
