...
export const shopifyEn: ProblemLandingContent = {
  ...
  costs: {
    ...
    items: [
      ...
      ["03", "Paid and social look smaller than they are", "GA4 put paid campaigns at 50% of Incapto's traffic; measured on every visit they were 62%. Organic social showed 133% more traffic in Sealmetrics than in GA4."],
    ],
  },
