...
export const magentoEn: ProblemLandingContent = {
  ...
  faq: [
    ...
    { question: "Does Sealmetrics replace Magento's reports or GA4?", answer: "It replaces neither by default. Magento's reports stay the source for orders, products and customers, and GA4 can stay as the Google Ads conduit. Sealmetrics becomes the channel and revenue view, measured without consent loss and checked against Magento's order totals." },
...
export const magentoEs: ProblemLandingContent = {
  ...
  faq: [
    ...
    { question: "¿Sealmetrics sustituye a los informes de Magento o a GA4?", answer: "Por defecto no sustituye a ninguno. Los informes de Magento siguen siendo la fuente de pedidos, productos y clientes, y GA4 puede quedarse como vía hacia Google Ads. Sealmetrics pasa a ser la visión de canal e ingresos, medida sin pérdida por consentimiento y contrastada con los totales de pedidos de Magento." },
