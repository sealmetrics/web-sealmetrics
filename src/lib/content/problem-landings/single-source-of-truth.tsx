...
export const singleSourceOfTruthEn: ProblemLandingContent = {
  ...
  costs: {
    ...
    items: [
      ...
      ["02", "Budget moved on the wrong base", "Consent loss is not even across channels. At Incapto, GA4 showed paid campaigns as 50% of traffic; measured without consent loss they were 62%. Twelve points of difference in the line that decides media allocation."],
  ...
  roles: {
    ...
    items: [
      { role: "CMO / Marketing", need: "Defend the budget with a number finance does not dispute.", how: "Channel revenue without consent loss, reconciled against orders before it reaches the board deck.", link: { label: "Analytics for CMOs", href: "/for/cmo/" } },
