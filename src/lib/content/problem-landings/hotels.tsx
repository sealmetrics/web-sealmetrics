...
export const hotelsEn: ProblemLandingContent = {
  ...
  divergence: {
    ...
    rows: [
      ["Arrival from meta-search, paid search or social", "The guest who rejects the banner, and the click that brought them", "Reads UTMs and click IDs from the landing URL, banner or no banner", "Consistent UTMs on Google Hotel Ads, meta-search and paid links"],
...
export const hotelsEs: ProblemLandingContent = {
  ...
  divergence: {
    ...
    rows: [
      ["Llegada desde metabuscadores, búsqueda de pago o redes", "Al huésped que rechaza el banner, y el clic que lo trajo", "Lee las UTM y los click IDs de la URL de llegada, haya banner o no", "UTM coherentes en Google Hotel Ads, metabuscadores y enlaces de pago"],
