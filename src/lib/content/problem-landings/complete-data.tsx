...
export const completeDataEn: ProblemLandingContent = {
  ...
  divergence: {
    ...
    note: (
      <>
        ...
        A real site lands somewhere between the model and full capture — which
  ...
  costs: {
    ...
    items: [
      ["01", "Budget drifts to the channels that lose least", "At Incapto, GA4 put paid campaigns at 50% of traffic; measured on every visit they were 62%. Direct lost least, so in GA4 it looked more important than it was."],
  ...
  divergence: {
    ...
    note: (
      <>
        ...
        Una web real queda entre el modelo y la captura completa, y por eso el
