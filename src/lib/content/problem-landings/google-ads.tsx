...
export const googleAdsEn: ProblemLandingContent = {
  ...
  heroBody:
    "Sealmetrics does not import conversions into Google Ads and does not feed Smart Bidding: the Google tag keeps that job. What it does is read the ValueTrack UTMs of every Google Ads click from the landing page, on every visit, and credit conversions and revenue to the campaign and keyword that brought the session — the figure to set beside Google's own before moving budget.",
  ...
  roles: {
    ...
    items: [
      ...
      { role: "PPC manager", need: "Keywords and placements on measured revenue.", how: "utm_term carries keyword and match type, or placement, so revenue per keyword can be read on every session.", link: { label: "Campaign revenue attribution", href: "/use-cases/revenue-attribution/" } },
  ...
  faq: [
    ...
    { question: "Does Sealmetrics import conversions into Google Ads or work with Smart Bidding?", answer: "No. Sealmetrics does not send conversions to Google Ads, so it does not feed Smart Bidding. Keep the Google tag or GA4 conversion import for bidding, and use Sealmetrics to measure revenue by campaign and keyword on every session when you decide budget between channels." },
...
export const googleAdsEs: ProblemLandingContent = {
  ...
  heroBody:
    "Sealmetrics no importa conversiones a Google Ads ni alimenta Smart Bidding: ese trabajo lo sigue haciendo la etiqueta de Google. Lo que hace es leer las UTM con ValueTrack de cada clic de Google Ads en la página de llegada, en cada visita, y acreditar conversiones e ingresos a la campaña y la palabra clave que trajeron la sesión: la cifra que conviene poner junto a la de Google antes de mover presupuesto.",
  ...
  answer: (
    <p>
      ...
      desde la URL en cada visita, sin cookies, y acredita cada conversión y sus
