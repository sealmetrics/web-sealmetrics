...
export const revenueAttributionEn: ProblemLandingContent = {
  ...
  module: {
    ...
    foot: "Same sale · up to three claimants · one of them measured without consent loss",
  },
  ...
  costs: {
    ...
    items: [
      ["01", "Paid looks worse than it is", "At Incapto, GA4 put paid campaigns at 50% of traffic; measured without consent loss they were 62%. The range on paid visits was 37% to 52% more than GA4, because GA4 groups part of the spend under Cross-network."],
  ...
  roles: {
    ...
    items: [
      ...
      { role: "CMO", need: "Move budget between channels without a fight.", how: "A channel mix measured without consent loss, so paid, social and organic are compared on the same base.", link: { label: "Analytics for CMOs", href: "/for/cmo/" } },
...
export const revenueAttributionEs: ProblemLandingContent = {
  ...
  module: {
    ...
    foot: "Misma venta · hasta tres aspirantes · uno medido sin pérdida por consentimiento",
  },
  ...
  roles: {
    ...
    items: [
      ...
      { role: "CMO", need: "Mover presupuesto entre canales sin una pelea.", how: "Un mix de canales medido sin pérdida por consentimiento, para comparar pago, social y orgánico sobre la misma base.", link: { label: "Analítica para CMOs", href: "/es/for/cmo/" } },
