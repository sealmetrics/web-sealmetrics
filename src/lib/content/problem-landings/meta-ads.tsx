...
export const metaAdsEn: ProblemLandingContent = {
  ...
  heroBody:
    "Sealmetrics does not send conversions to Meta and does not replace the pixel or the Conversions API: bidding keeps running on them. What it does is read the UTMs of every Meta ad click from the landing page, on every visit, and credit conversions and revenue to the campaign, ad set and ad that brought the session, so Meta's reported results can be set beside a figure Meta does not produce.",
  ...
  answer: (
    <p>
      ...
      reads those values server-side from the URL on every visit, without cookies,
  ...
  roles: {
    ...
    items: [
      ...
      { role: "Paid social manager", need: "Ad sets and creatives on measured revenue.", how: "utm_term and utm_content carry the ad set and the ad, so revenue per creative can be read on every session.", link: { label: "Campaign revenue attribution", href: "/use-cases/revenue-attribution/" } },
  ...
  proof: {
    ...
    figures: [
      ...
      { value: "62%", label: "paid campaigns' share of traffic measured on every visit, against 50% in GA4", client: "Incapto", href: "/case-studies/incapto/" },
    ],
  ...
  faq: [
    ...
    { question: "Does Sealmetrics send conversions to Meta or replace the Conversions API?", answer: "No. Sealmetrics does not send conversions to Meta, so it does not affect delivery or optimisation. Keep the Meta pixel and the Conversions API for Meta, and use Sealmetrics to measure revenue by campaign, ad set and ad on every session when you decide budget between channels." },
...
export const metaAdsEs: ProblemLandingContent = {
  ...
  heroBody:
    "Sealmetrics no envía conversiones a Meta ni sustituye al píxel o a la API de conversiones: la entrega de anuncios sigue funcionando con ellos. Lo que hace es leer las UTM de cada clic en un anuncio de Meta en la página de llegada, en cada visita, y acreditar conversiones e ingresos a la campaña, el conjunto de anuncios y el anuncio que trajeron la sesión, para poner los resultados de Meta junto a una cifra que Meta no produce.",
  ...
  answer: (
    <p>
      ...
      anuncios y el anuncio. Sealmetrics lee esos valores en servidor desde la URL en
      cada visita, sin cookies, y acredita cada conversión y sus ingresos a la campaña,
  ...
  roles: {
    ...
    items: [
      ...
      { role: "Responsable de paid social", need: "Conjuntos y creatividades con ingresos medidos.", how: "utm_term y utm_content llevan el conjunto y el anuncio, así que los ingresos por creatividad se leen en cada sesión.", link: { label: "Atribución de ingresos por campaña", href: "/es/use-cases/revenue-attribution/" } },
  ...
  proof: {
    ...
    figures: [
      ...
      { value: "62%", label: "del tráfico eran campañas de pago medidas en cada visita, frente al 50% en GA4", client: "Incapto", href: "/es/case-studies/incapto/" },
    ],
