...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    readTime: "9 min",
    author: AUTHORS.rafa,
    related: ["why-ga4-misses-traffic", "consent-banner-impact-on-analytics", "cookieless-analytics-for-ecommerce"],
  },
  {
  ...
  },
  {
    ...
    description:
      "Adobe Analytics can be deployed compliantly under GDPR — consent, a DPA, a transfer assessment and deliberate configuration. What that costs you is not legal, it is the visitors who reject consent and never get measured.",
    date: "2026-07-28",
    dateModified: "2026-09-21",
    category: "Regulation",
    readTime: "8 min",
  ...
  {
    slug: "why-ga4-misses-traffic",
    title: "Why GA4 Doesn't See Part of Your Traffic",
    description:
  ...
  },
  {
    ...
    readTime: "7 min",
    author: AUTHORS.rafa,
    related: ["analytics-tools-data-sampling", "why-ga4-misses-traffic", "ga4-alternatives-enterprise"],
  },
  {
  ...
  },
  {
    ...
    readTime: "6 min",
    author: AUTHORS.rafa,
    related: ["why-ga4-misses-traffic", "cookieless-analytics-explained", "eu-digital-omnibus-cookie-banners-analytics"],
  },
  {
    ...
    readTime: "5 min",
    author: AUTHORS.rafa,
    related: ["what-is-data-loss-in-analytics", "why-ga4-misses-traffic", "best-enterprise-analytics-platforms"],
  },
  {
    ...
    readTime: "7 min",
    author: AUTHORS.rafa,
    related: ["consent-banner-impact-on-analytics", "what-is-data-loss-in-analytics", "why-ga4-misses-traffic"],
  },
  {
  ...
  },
  {
    ...
    readTime: "7 min",
    author: AUTHORS.rafa,
    related: ["why-ga4-misses-traffic", "consent-banner-impact-on-analytics", "multi-touch-attribution-complete-data"],
  },
  {
    ...
    readTime: "10 min",
    author: AUTHORS.rafa,
    related: ["best-enterprise-analytics-platforms", "ga4-data-sampling-problem", "why-ga4-misses-traffic"],
  },
  {
