...
export const ROAS_STEPS_EN = [
  ...
  {
    name: "Record revenue on every session",
...
export const ROAS_STEPS_ES = [
  ...
  {
    name: "Registra los ingresos en cada sesión",
...
export const ROAS_FAQ_EN = [
  {
    ...
    answer:
      "Calculate it twice with the same spend: once with the revenue each ad platform reports, and once with revenue measured on every session, independently of the banner, and reconciled with your real orders. Use the platform figure to bid inside that platform and the measured figure to allocate budget between channels.",
  },
  {
