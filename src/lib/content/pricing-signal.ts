export const pricingSignalFaqs = {
  en: [
    ...
    ["What is the Agentic Package?", "A self-service tier provisioned from an MCP-capable assistant. It includes aggregate cookieless analytics for up to 1M human events in total, documentation-only support and no card."],
  ...
  es: [
    ...
    ["¿Qué es el Agentic Package?", "Un tier self-service aprovisionado desde un asistente compatible con MCP. Incluye analítica agregada sin cookies hasta 1M de eventos humanos en total, soporte sólo por documentación y sin tarjeta."],
