...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Consentless Analytics for DTC — 2026 Guide",
    description:
      "No consent banner needed in our self-assessment. No cookies. No user tracking. Aggregate channel totals without consent gaps.",
    type: "article",
  ...
  twitter: {
    ...
    site: "@sealmetrics",
    title: "Consentless Analytics for DTC — 2026 Guide",
    description: "No consent banner needed in our self-assessment. No cookies. No user tracking. Aggregate channel totals without consent gaps.",
    images: [ogImage("/blog/consentless-analytics-for-dtc/")],
  },
  alternates: {
        ...
        <div className="max-w-[936px] mx-auto px-5 sm:px-8">
          ...
          <div className="mb-12 p-6 bg-warm-white border border-warm-100 rounded-[4px]">
            ...
            <ul className="space-y-2 text-[0.9rem] leading-[1.7] text-text-secondary list-none pl-0 [&>li]:relative [&>li]:pl-6 [&>li]:before:content-['—'] [&>li]:before:absolute [&>li]:before:left-0 [&>li]:before:text-text-tertiary">
              <li>Consentless analytics = no cookies, no localStorage, no fingerprinting, no personal identifiers, no per-user tracking. That is why it is designed to need no consent under GDPR/ePrivacy; your DPO confirms for your setup.</li>
          ...
          <div className="space-y-6 text-[1.05rem] leading-[1.8] text-text-body">
            ...
            <p>
              Some &ldquo;cookieless&rdquo; analytics tools still use localStorage or device fingerprinting and technically still need consent. Fully consentless tools avoid all of them. Both are better than cookie-based, but only consentless is designed to stay out of the consent requirement.
            </p>
