...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Consentless Analytics for DTC — 2026 Guide",
    description:
      "No cookies. No user tracking. Aggregate channel totals without consent gaps.",
    type: "article",
  ...
  twitter: {
    ...
    site: "@sealmetrics",
    title: "Consentless Analytics for DTC — 2026 Guide",
    description: "No cookies. No user tracking. Aggregate channel totals without consent gaps.",
    images: [ogImage("/blog/consentless-analytics-for-dtc/")],
  },
  alternates: {
    ...
    <>
      ...
      <article className="pt-12 pb-28 bg-white">
        <div className="max-w-[936px] mx-auto px-5 sm:px-8">
          ...
          <CommercialModule
            hook="Consentless means the banner stops deciding what your dashboard sees. Measure your DTC funnel without consent loss, including the visitors who reject the banner."
          />
