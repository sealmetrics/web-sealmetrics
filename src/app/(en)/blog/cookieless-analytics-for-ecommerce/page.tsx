      ...
      <article className="pt-12 pb-28 bg-white">
        <div className="max-w-[936px] mx-auto px-5 sm:px-8">
          ...
          <div className="space-y-6 text-[1.05rem] leading-[1.8] text-text-body">
            ...
            <p>
              <strong>4. No cookies, no consent needed.</strong> Because nothing is stored on or read from the visitor&apos;s device, the analytics falls outside the storage-and-access provisions of the ePrivacy Directive and meets the CNIL and AEPD criteria for consent-exempt audience measurement (self-assessed). No banner needed. The 40–60% consent-rejection gap disappears because there is nothing to reject.
            </p>
