...
export const metadata = buildRedirectMetadata("/cookieless-analytics/", { label: "/cookieless-analytics/" });

export default function Page() {
  return <RedirectStub to="/cookieless-analytics/" label="/cookieless-analytics/" />;
}
