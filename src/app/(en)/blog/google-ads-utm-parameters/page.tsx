...
export const metadata = buildRedirectMetadata("/integrations/google-ads/", { label: "/integrations/google-ads/" });

export default function Page() {
  return <RedirectStub to="/integrations/google-ads/" label="/integrations/google-ads/" />;
}
