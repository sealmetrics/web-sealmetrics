...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "GA4 data-driven, platform models, marketing mix models and incrementality tests against last click on every session. Where each one fails, and how to combine them.",
    type: "article",
    images: [ogImage(`${URL}/`)],
      ...
      <article className="pt-12 pb-28 bg-white">
        <div className="max-w-[936px] mx-auto px-5 sm:px-8">
          ...
          <p className="tldr mb-12 text-[1.15rem] leading-[1.7] text-text-secondary font-serif italic">
            ...
            platform models to bid, last click on every session to allocate budget,
          ...
          <div className="key-takeaways mb-12 p-6 bg-warm-white border border-warm-100 rounded-[4px]">
            ...
            <ul className={`text-[0.9rem] leading-[1.7] text-text-secondary ${dashList}`}>
              ...
              <li>Last click is narrow but auditable, identical across channels and possible on every session, so its totals can be reconciled with real orders.</li>
          ...
          <div className="space-y-6 text-[1.05rem] leading-[1.8] text-text-body">
            ...
            <ul className={dashList}>
              ...
              <li><strong>It can run on every session.</strong> Session-scoped last click needs no identifier, so it does not depend on consent and its totals can be reconciled with the orders you really took.</li>
            </ul>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-[0.95rem] border-collapse min-w-[560px]">
                ...
                <tbody>
                  ...
                  <tr><td className={td}>Weekly budget between channels and campaigns</td><td className={td}>Last click on every session, reconciled with real orders</td></tr>
            ...
            <p>
              ...
              by channel and campaign, measured on every session, available through the API
          ...
          <CommercialModule hook="Modelled attribution on the consenting fraction, or last click on every session? See both on your own channel mix, reconciled with your orders." />
