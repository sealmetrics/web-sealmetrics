      ...
      <article className="pt-12 pb-28 bg-white">
        <div className="max-w-[936px] mx-auto px-5 sm:px-8">
          ...
          <p className="tldr mb-12 text-[1.15rem] leading-[1.7] text-text-secondary font-serif italic">
            ...
            click on every visit. Choose by the decision you need to make.
          </p>
          ...
          <div className="key-takeaways mb-12 p-6 bg-warm-white border border-warm-100 rounded-[4px]">
            ...
            <ul className={`text-[0.9rem] leading-[1.7] text-text-secondary ${dashList}`}>
              ...
              <li>Sealmetrics does less, on purpose: no user identifiers, no tag manager, no consent manager, last click only. In exchange it measures every visit the same way and reconciles with orders.</li>
          ...
          <div className="space-y-6 text-[1.05rem] leading-[1.8] text-text-body">
            ...
            <p>
              ...
              48 days, and paid campaigns fell from 62% of traffic measured on every visit
              to 50% in GA4.
            </p>
            <p>
            ...
            <ul className={dashList}>
              <li><strong>The decision is budget between channels and campaigns.</strong> Revenue by channel, campaign and creative, credited on every visit, and checkable against orders.</li>
