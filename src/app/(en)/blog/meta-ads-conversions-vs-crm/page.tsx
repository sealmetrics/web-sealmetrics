      ...
      <article className="pt-12 pb-28 bg-white">
        <div className="max-w-[936px] mx-auto px-5 sm:px-8">
          ...
          <p className="tldr mb-12 text-[1.15rem] leading-[1.7] text-text-secondary font-serif italic">
            ...
            conversions measured on your site from Meta traffic, without consent loss.
          </p>
          ...
          <div className="space-y-6 text-[1.05rem] leading-[1.8] text-text-body">
              ...
              <table className="w-full text-[0.95rem] border-collapse min-w-[640px]">
                <thead>
                  <tr>
                    ...
                    <th className={th}>Site analytics, without consent loss</th>
            ...
            <p>
              ...
              Meta ads, measured whether or not the visitor accepted
            ...
            <ol className="list-decimal pl-5 space-y-3">
              ...
              <li><strong>Tag every Meta ad.</strong> Add utm_source (facebook or instagram), utm_medium, utm_campaign and utm_content for the ad, so that each visit from Meta is identifiable on your site without a cookie.</li>
          ...
          <CommercialModule hook="Meta says one number, your CRM another? We measure conversions from Meta traffic without consent loss and set them between the two, week by week." />
