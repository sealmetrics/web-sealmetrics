      ...
      <article className="pt-12 pb-28 bg-white">
        ...
        <div className="mb-12 p-6 bg-warm-white border border-warm-100 rounded-[4px]">
          ...
          <ul className="space-y-2 text-[0.9rem] leading-[1.7] text-text-secondary list-none pl-0 [&>li]:relative [&>li]:pl-6 [&>li]:before:content-['—'] [&>li]:before:absolute [&>li]:before:left-0 [&>li]:before:text-text-tertiary">
            ...
            <li>Complete data does not rescue multi-touch: without a persistent identifier there is no journey to split credit across. What it does is make last-click honest — credited on every session, not on the consenting fraction.</li>
          </ul>
        </div>
