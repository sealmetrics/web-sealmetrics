      ...
      <article className="pt-12 pb-28 bg-white">
        <div className="max-w-[936px] mx-auto px-5 sm:px-8">
          ...
          <p className="tldr mb-12 text-[1.15rem] leading-[1.7] text-text-secondary font-serif italic">
            ...
            revenue each ad platform reports, and once with revenue measured on
            every session and reconciled with your real orders, both divided by the
          ...
          <div className="key-takeaways mb-12 p-6 bg-warm-white border border-warm-100 rounded-[4px]">
            ...
            <ul className={`text-[0.9rem] leading-[1.7] text-text-secondary ${dashList}`}>
              ...
              <li>The undercount is uneven. On Incapto&apos;s Shopify store, GA4 put paid campaigns at 50% of traffic; measured on every visit they were 62%.</li>
          ...
          <div className="space-y-6 text-[1.05rem] leading-[1.8] text-text-body">
            ...
            <p>
              ...
              and 62% measured on every visit. An analytics ROAS built on that base
          ...
          <CommercialModule hook="Three ROAS numbers for one campaign? We measure revenue on every session, reconcile it with your orders and set it next to your platform ROAS." />
