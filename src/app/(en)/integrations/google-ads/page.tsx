...
const DESCRIPTION =
  "Track Google Ads campaigns and keywords in Sealmetrics with ValueTrack UTMs, measured on every visit. What it does, the templates, and what it does not do.";
const SOCIAL =
  "Google Ads bids on its own number. Sealmetrics measures revenue by campaign and keyword on every visit, so budget decisions use the measured one.";
