...
const DESCRIPTION =
  "Track Meta Ads campaigns, ad sets and creatives in Sealmetrics with UTM parameters, measured on every visit. Setup, parameters and what it does not do.";
const SOCIAL =
  "Meta reports the results it credits. Sealmetrics measures revenue by campaign, ad set and creative on every visit, beside Meta's own figure.";
