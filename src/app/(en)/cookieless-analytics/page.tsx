      ...
      <TldrBlock
        answer={
          <>
            ...
            or personal identifiers. It captures the traffic cookie-based
            tools lose because there is no cookie for browsers to expire or
            for visitors to reject, and served first-party there is no
            third-party domain for ad blockers to match. The
