...
import { GDPR_ANALYTICS_MODIFIED, GDPR_ANALYTICS_PUBLISHED, gdprAnalyticsEn as content } from "@/lib/content/problem-landings/gdpr-analytics";
    ...
    <>
      ...
      <JsonLd
        data={articleSchema({
          headline: TITLE,
          description: DESCRIPTION,
          datePublished: GDPR_ANALYTICS_PUBLISHED,
