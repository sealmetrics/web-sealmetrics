    ...
    <>
      ...
      <article className="pt-12 pb-28 bg-white">
        ...
        <div className="space-y-6 text-[1.05rem] leading-[1.8] text-text-body">
          ...
          <p>A share of EU users, larger on desktop and in technical audiences, run ad blockers that specifically target third-party analytics requests. First-party data collection avoids most of this loss — not through deception, but by fundamentally changing the data path to be genuinely first-party.</p>
        ...
        <div className="mt-12">
          <QuickAnswer>
            ...
            <p>
              For EU eCommerce, this matters because ad blockers silently drop part of the third-party analytics calls before they execute, and Safari caps third-party cookies entirely. First-party collection reduces the first loss and removes the second. Combined with no cookie or identifier stored on the device, it forms the architectural basis of consentless analytics — the same data path GDPR and the CNIL exemption criteria contemplate when describing analytics that do not require a consent banner.
            </p>
          </QuickAnswer>
        </div>
      </div>
