    ...
    <>
      ...
      <article className="pt-12 pb-28 bg-white">
        ...
        <div className="space-y-6 text-[1.05rem] leading-[1.8] text-text-body">
          ...
          <p>Revenue attribution is uniquely sensitive to <Link href="/glossary/data-loss-in-analytics" className="text-text-primary no-underline border-b border-warm-200 pb-0.5 hover:border-text-primary transition-colors">data loss</Link>. If your analytics miss pageviews to consent rejection, ad blockers and browser restrictions &mdash; 45% of pageviews on a <Link href="/case-studies/incapto" className="text-text-primary no-underline border-b border-warm-200 pb-0.5 hover:border-text-primary transition-colors">real Shopify store measured over 48 days</Link>, up to 87% in the compounded worst case &mdash; what remains is what the attribution model operates on, so the channel totals it produces are biased by whatever demographic survived the filter. The typical result: direct traffic is inflated, top-of-funnel channels are undervalued, and budget allocation follows the bias.</p>
