    ...
    <>
      ...
      <article className="pt-12 pb-28 bg-white">
        ...
        <div className="space-y-6 text-[1.05rem] leading-[1.8] text-text-body">
          ...
          <p>Multi-touch attribution is only as accurate as the touchpoint data feeding it. When cookie-based analytics miss visitor interactions &mdash; 29% of visits on a <Link href="/case-studies/incapto" className="text-text-primary no-underline border-b border-warm-200 pb-0.5 hover:border-text-primary transition-colors">real Shopify store measured over 48 days</Link>, up to 87% in the compounded worst case &mdash; due to <Link href="/glossary/consent-management-platform" className="text-text-primary no-underline border-b border-warm-200 pb-0.5 hover:border-text-primary transition-colors">consent rejection</Link>, ad blockers, and browser restrictions, the model distributes credit across a fragment of the observed data.</p>
        ...
        <div className="mt-12">
          <QuickAnswer>
            ...
            <p>
              When the underlying data is incomplete — and in the EU, cookie-based analytics loses traffic to consent rejection (15–60%, depending on sector, brand strength and traffic mix), ad blockers (~25%) and browser restrictions: 29% of visits on a real Shopify store measured over 48 days, and as much as 87% in the compounded worst case — multi-touch attribution distributes credit across a biased fragment, systematically undervaluing top-of-funnel channels. Sealmetrics deliberately does not implement multi-touch attribution: by avoiding per-visitor identifiers entirely, it measures traffic without depending on consent and attributes each conversion last-click at channel level.
            </p>
          </QuickAnswer>
        </div>
      </div>
