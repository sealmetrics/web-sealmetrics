      ...
      <article className="pt-12 pb-28 bg-white">
        ...
        <div className="mt-12">
          <QuickAnswer>
            ...
            <p>
              When the underlying data is incomplete — and in the EU, cookie-based analytics loses traffic to consent rejection (40-60%), ad blockers (~25%) and browser restrictions: 29% of visits on a real Shopify store measured over 48 days, and as much as 87% in the compounded worst case — multi-touch attribution distributes credit across a biased fragment, systematically undervaluing top-of-funnel channels. Sealmetrics deliberately does not implement multi-touch attribution: by avoiding per-visitor identifiers entirely, it captures 100% of traffic and attributes each conversion last-click at channel level.
            </p>
          </QuickAnswer>
        </div>
      </div>
