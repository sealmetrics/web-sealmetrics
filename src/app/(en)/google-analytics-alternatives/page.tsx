...
export const metadata = buildRedirectMetadata("/alternatives/google-analytics/", { label: "/alternatives/google-analytics/" });

export default function Page() {
  return <RedirectStub to="/alternatives/google-analytics/" label="/alternatives/google-analytics/" />;
}
