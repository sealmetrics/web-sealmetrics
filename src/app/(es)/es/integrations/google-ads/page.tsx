...
const DESCRIPTION =
  "Mide campañas y palabras clave de Google Ads en Sealmetrics con UTM y ValueTrack en cada visita. Qué hace, las plantillas y lo que no hace.";
const SOCIAL =
  "Google Ads puja con su propia cifra. Sealmetrics mide los ingresos por campaña y palabra clave en cada visita para decidir presupuesto con la medida.";
