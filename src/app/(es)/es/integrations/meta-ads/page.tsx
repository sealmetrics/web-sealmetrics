...
const DESCRIPTION =
  "Mide campañas, conjuntos y creatividades de Meta Ads en Sealmetrics con parámetros UTM, sin pérdida por consentimiento. Configuración, parámetros y lo que no hace.";
const SOCIAL =
  "Meta reporta los resultados que se acredita. Sealmetrics mide los ingresos por campaña, conjunto y creatividad sin pérdida por consentimiento, junto a la cifra de Meta.";
