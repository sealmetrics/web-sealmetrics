...
const faqs = [
  ...
  },
  {
    ...
    a: "Consent Mode es una capa de modelado: cuando los visitantes rechazan cookies, Google estima los datos que faltan estadísticamente. Sigue siendo basado en cookies. Parte de lo que ves en GA4 con Consent Mode es un modelo del tráfico que no puedes medir. La analítica sin cookies es una capa de medición — los visitantes se cuentan acepten o no el banner, sin modelo. Responden preguntas distintas.",
  },
  {
