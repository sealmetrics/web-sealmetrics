...
export const metadata: Metadata = {
  ...
  description:
    "Comparativa honesta. En nuestra experiencia, el 40–60% del tráfico rechaza cookies y GA4 no lo ve. Sealmetrics no depende del consentimiento.",
  openGraph: {
    title: "Sealmetrics vs Google Analytics 4 — Datos completos",
...
const faqs = [
  ...
  { q: "¿De dónde sale la cifra del 40–60% de rechazo de cookies?", a: "Es nuestra experiencia con clientes, no una media del mercado, y es un rango: entre el 40% y el 60% del tráfico no acepta cookies, y de quienes las aceptan, el 40% no lo hace en la primera página vista. Dónde cae cada web depende del sector, la fuerza de la marca y el mix de tráfico: una marca reconocida cuyas visitas llegan sobre todo en directo se queda en la parte baja; una web que vive de captación de pago en frío en un mercado sensible a la privacidad, en la alta. Como caso medido, en la tienda Shopify de Incapto GA4 no registró el 29% de las visitas ni el 45% de las páginas vistas durante 48 días. Corre las dos herramientas en paralelo para conocer tu cifra." },
      ...
      <section className="bg-warm-white border-t border-warm-100 py-12">
        <div className="max-w-[1100px] mx-auto px-5 sm:px-8">
          <QuickAnswer label="Respuesta rápida">
            ...
            <p>
              Para el eCommerce europeo el gap es estructural: GA4 no ve a quien rechaza el consentimiento — en nuestra experiencia con clientes, entre el 40% y el 60% del tráfico no acepta cookies — y reconstruye parte de ese hueco con modelado estadístico, mientras la ITP de Safari y los ad blockers erosionan más. Sealmetrics mide ese mismo tráfico con un píxel first-party ligero — sin cookies, sin muestreo, sin revisión Schrems II — así el revenue del informe cuadra con Shopify. La mayoría corre ambos en paralelo 30 días, concilia con su CRM y mueve las decisiones de revenue a Sealmetrics manteniendo GA4 como conducto de Google Ads.
            </p>
          </QuickAnswer>
        </div>
      </section>
