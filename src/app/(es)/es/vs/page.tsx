...
const comparisons = [
  { slug: "es/vs-ga4", name: "Google Analytics 4", stat: "15–60% de visitas UE, según sector", tagline: "El default gratis que todos usan — y su punto ciego estructural en Europa." },
