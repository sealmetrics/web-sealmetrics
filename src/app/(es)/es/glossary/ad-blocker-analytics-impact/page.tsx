    ...
    <>
      ...
      <article className="pt-12 pb-28 bg-white">
        ...
        <div className="space-y-6 text-[1.05rem] leading-[1.8] text-text-body">
          ...
          <p>
            El uso de bloqueadores es desigual: mayor en escritorio que en móvil, y mayor en audiencias técnicas que entre compradores generalistas. Y no es la única pérdida. En una herramienta que depende del consentimiento se suma al rechazo del <Link href={glossaryHref("consent-management-platform", "es")} className="text-text-primary no-underline border-b border-warm-200 pb-0.5 hover:border-text-primary transition-colors">banner de consentimiento</Link> (en nuestra experiencia con clientes, entre el 40% y el 60% del tráfico no acepta cookies) y a las restricciones de los navegadores. Cuánto se llevan entre todas depende de cada web: en la <Link href="/es/case-studies/incapto" className="text-text-primary no-underline border-b border-warm-200 pb-0.5 hover:border-text-primary transition-colors">tienda Shopify de Incapto, medida durante 48 días</Link>, GA4 no registró el 29% de las visitas.
          </p>
          <p>
