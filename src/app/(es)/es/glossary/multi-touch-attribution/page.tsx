    ...
    <>
      ...
      <article className="pt-12 pb-28 bg-white">
        ...
        <div className="space-y-6 text-[1.05rem] leading-[1.8] text-text-body">
          ...
          <p>La atribución multi-touch es tan precisa como los datos que la alimentan. Cuando la analítica con cookies pierde interacciones &mdash;el 29% de las visitas en una <Link href="/es/case-studies/incapto" className="text-text-primary no-underline border-b border-warm-200 pb-0.5 hover:border-text-primary transition-colors">tienda Shopify real medida durante 48 días</Link>, hasta el 87% en el peor escenario acumulado&mdash; por <Link href="/glossary/consent-management-platform" className="text-text-primary no-underline border-b border-warm-200 pb-0.5 hover:border-text-primary transition-colors">rechazo de consentimiento</Link>, bloqueadores y restricciones de navegador, el modelo reparte crédito sobre un fragmento del dato observado.</p>
