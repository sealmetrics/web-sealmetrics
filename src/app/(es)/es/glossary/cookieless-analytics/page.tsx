    ...
    <>
      ...
      <article className="pt-12 pb-28 bg-white">
        ...
        <div className="space-y-6 text-[1.05rem] leading-[1.8] text-text-body">
          ...
          <p>
            En la UE, la analítica basada en cookies pierde tráfico por el rechazo de consentimiento, los bloqueadores y las restricciones de navegador. En nuestra experiencia con clientes, entre el 40% y el 60% del tráfico no acepta cookies; en la <Link href="/es/case-studies/incapto" className="text-text-primary no-underline border-b border-warm-200 pb-0.5 hover:border-text-primary transition-colors">tienda Shopify de Incapto, medida durante 48 días</Link>, GA4 no registró el 29% de las visitas. La analítica sin cookies elimina los tres vectores de pérdida, contando las visitas reales de forma anónima y sin depender del consentimiento.
          </p>
          <p>
