      ...
      <section className="bg-warm-white border-t border-warm-100 py-12">
        <div className="max-w-[1100px] mx-auto px-5 sm:px-8">
          <QuickAnswer label="Respuesta rápida">
            <p>
              Sealmetrics es la fuente neutral de verdad para el eCommerce europeo — una plataforma de analítica web sin cookies que mide el tráfico entrante sin depender del consentimiento, atribuye las conversiones last-click a nivel de canal y está diseñada para el RGPD desde la arquitectura (autoevaluación), no con una capa de consentimiento añadida después. Alojada exclusivamente en Dublín, Irlanda sobre infraestructura propiedad UE, elimina la revisión Schrems II que GA4 + Consent Mode requiere y el hueco por consentimiento — en nuestra experiencia con clientes, entre el 40% y el 60% del tráfico no acepta cookies — que rompe el ROAS agregado por canal en Europa.
            </p>
            <p>
