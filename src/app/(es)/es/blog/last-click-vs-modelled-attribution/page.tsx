...
const DESCRIPTION =
  "La atribución basada en datos responde mejor pregunta en los recorridos que ve; el último clic, una más estrecha sin consentimiento. Cuándo usar cada una.";
const SOCIAL =
  "Atribución basada en datos de GA4, modelos de las plataformas, marketing mix y tests de incrementalidad frente al último clic sin pérdida por consentimiento. Dónde falla cada uno y cómo combinarlos.";
...
const FAQ = [
  ...
  },
  {
    ...
    answer:
      "Responde a una pregunta mejor —cuánto aportó cada punto de contacto—, pero solo en los recorridos que puede observar, que necesitan un identificador persistente y, en Europa, consentimiento de cookies. El último clic responde a una pregunta más estrecha y puede funcionar sin consentimiento. La basada en datos es mejor para pujar dentro de una plataforma; el último clic sobre datos completos suele ser más fiable para repartir presupuesto entre canales.",
  },
  {
      ...
      <article className="pt-12 pb-28 bg-white">
        <div className="max-w-[936px] mx-auto px-5 sm:px-8">
          ...
          <p className="tldr mb-12 text-[1.15rem] leading-[1.7] text-text-secondary font-serif italic">
            ...
            los modelos de las plataformas para pujar, el último clic sin pérdida por consentimiento para
          ...
          <div className="key-takeaways mb-12 p-6 bg-warm-white border border-warm-100 rounded-[4px]">
            ...
            <ul className={`text-[0.9rem] leading-[1.7] text-text-secondary ${dashList}`}>
              ...
              <li>El último clic es estrecho pero auditable, igual para todos los canales y posible sin consentimiento, así que sus totales se pueden conciliar con los pedidos reales.</li>
          ...
          <div className="space-y-6 text-[1.05rem] leading-[1.8] text-text-body">
            ...
            <ul className={dashList}>
              ...
              <li><strong>Puede funcionar sin consentimiento.</strong> El último clic por sesión no necesita identificador, así que no depende del consentimiento y sus totales se pueden conciliar con los pedidos que realmente entraron.</li>
            </ul>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-[0.95rem] border-collapse min-w-[560px]">
                ...
                <tbody>
                  ...
                  <tr><td className={td}>Reparto semanal de presupuesto entre canales y campañas</td><td className={td}>Último clic sin pérdida por consentimiento, conciliado con los pedidos reales</td></tr>
            ...
            <p>
              ...
              campaña, medidos sin pérdida por consentimiento y disponibles por API y con el conector de
          ...
          <CommercialModule
            locale="es"
            hook="¿Atribución modelada sobre la parte que consiente, o último clic sin pérdida por consentimiento? Ve las dos sobre tu propio mix de canales, conciliadas con tus pedidos."
          />
