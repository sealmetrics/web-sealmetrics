        ...
        <div className="max-w-[936px] mx-auto px-5 sm:px-8">
          ...
          <div className="space-y-6 text-[1.05rem] leading-[1.8] text-text-body">
            ...
            <p>
              ...
              medido sin pérdida por consentimiento al 50% en GA4.
            </p>
            <p>
            ...
            <ul className={dashList}>
              <li><strong>La decisión es el presupuesto entre canales y campañas.</strong> Ingresos por canal, campaña y creatividad, acreditados sin pérdida por consentimiento y contrastables con los pedidos.</li>
