      ...
      <article className="pt-12 pb-28 bg-white">
        ...
        <div className="mb-12 p-6 bg-warm-white border border-warm-100 rounded-[4px]">
          ...
          <ul className="space-y-2 text-[0.9rem] leading-[1.7] text-text-secondary list-none pl-0 [&>li]:relative [&>li]:pl-6 [&>li]:before:content-['—'] [&>li]:before:absolute [&>li]:before:left-0 [&>li]:before:text-text-tertiary">
            ...
            <li>El tracking con cookies puede quedarse en torno al 13% del tráfico UE en el peor escenario, con todas las pérdidas sumadas, y en una tienda Shopify real medida durante 48 días GA4 no registró el 29% de las visitas; el tracking cookieless captura el 100% porque no hay nada que bloquear, rechazar ni que expire.</li>
        ...
        <div className="space-y-6 text-[1.05rem] leading-[1.8] text-text-body">
              ...
              <tbody>
                {[
                  ...
                  },
                  {
                    ...
                    cookie: "Depende del consentimiento",
                    cookieless: "100%",
                  },
                ].map((row) => (
                  <tr
          ...
          <p>
            ...
            Modelos de atribución que eran poco fiables sobre la fracción del tráfico que acepta cookies pasan a ser útiles
