...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Sí, con consentimiento. GA4 coloca cookies y trata datos personales (client ID, localización por IP), así que requiere banner y consentimiento previo bajo la LSSI-CE y el RGPD. La consecuencia práctica: GA4 no ve parte de tu tráfico. El rechazo del consentimiento, los ad blockers y las restricciones del navegador se llevan cada uno una parte, y cuánto depende de la tienda y del canal. En la tienda Shopify de Incapto, medida durante 48 días, GA4 con Consent Mode no registró el 29% de las visitas. Legal con consentimiento, sí; completo, no.",
  },
  {
    question: "¿Qué analítica RGPD puede usar un pequeño negocio?",
    answer:
      "Depende de lo que decidas con el dato. Para una web pequeña sin inversión publicitaria, una herramienta ligera privacy-first (Plausible, Fathom, Umami — desde unos 9 €/mes) cumple y es suficiente. Cuando inviertes en campañas y asignas presupuesto con el dato — típicamente a partir de unos miles de euros al mes en ads — lo que pierde una herramienta con banner — entre el 15% y el 60% del tráfico, según el sector, la fuerza de la marca y el mix de tráfico — cuesta más que la propia analítica: ahí una plataforma cookieless con atribución de revenue como Sealmetrics (desde 599 €/mes) se paga sola.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "GA4 no ve parte de tu tráfico: el rechazo del consentimiento se lleva una parte que depende del sector, la fuerza de la marca y el mix de tráfico; los ad blockers restan otra que depende de la audiencia, y los navegadores restringen las cookies. Cuánto en total depende de la tienda y del canal. Medido en la tienda Shopify de Incapto durante 48 días, GA4 no registró el 29% de las visitas ni el 45% de las páginas vistas, y las mayores pérdidas se concentraron en redes sociales orgánicas, afiliación y búsqueda orgánica. Para una tienda online eso significa atribución de campañas y tasas de conversión calculadas sobre una fracción de la realidad. Puedes cuantificar tu caso con la calculadora de pérdida de datos de Sealmetrics.",
  },
];
      ...
      <article className="pt-12 pb-28 bg-white">
        <div className="max-w-[936px] mx-auto px-5 sm:px-8">
          ...
          <div className="space-y-6 text-[1.05rem] leading-[1.8] text-text-body">
            ...
            <p>
              Todas las respuestas se reducen al mismo test en dos partes: ¿la herramienta almacena algo en el dispositivo del visitante? y ¿trata datos personales? Falla cualquiera de las dos y necesitas banner — con la pérdida de dato que trae consigo: entre el 15% y el 60% de las visitas UE, según el sector, la fuerza de la marca y el mix de tráfico. Supera las dos, como hace la medición anónima y agregada bajo la guía de la AEPD, y no se requiere banner para la analítica. Si quieres auditar tu stack actual contra todos los requisitos — no solo los españoles — recorre el <Link href="/es/reg-gap-analysis" className="text-text-primary no-underline border-b border-warm-200 pb-0.5 hover:border-text-primary transition-colors">análisis de brechas regulatorias</Link>, y cuantifica lo que te cuesta el banner con la <Link href="/es/data-loss-calculator" className="text-text-primary no-underline border-b border-warm-200 pb-0.5 hover:border-text-primary transition-colors">calculadora de pérdida de datos</Link>.
            </p>
