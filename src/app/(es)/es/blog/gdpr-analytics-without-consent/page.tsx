  ...
  return (
    <>
      ...
      <article className="pt-12 pb-28 bg-white">
        ...
        <CommercialModule
          locale="es"
          hook="¿Cuánto dato recuperarías midiendo sin banner? Una herramienta con banner no mide a quien lo rechaza — ve en una demo tus informes sin esa pérdida por consentimiento."
        />
