...
const SOCIAL =
  "Sin cookies y sin seguir a nadie: totales por canal que incluyen a quien rechaza el banner. Qué es y cómo encaja en un stack DTC.";
...
const FAQ = [
  ...
  },
  {
    ...
    answer:
      "Una marca DTC vende directamente al consumidor con paid media como motor, y sus decisiones de presupuesto dependen de atribuir la inversión a ingresos. Quien rechaza el banner desaparece de la analítica con consentimiento, así que el ROAS se calcula solo sobre quienes aceptaron. En la tienda Shopify de Incapto, GA4 situaba las campañas de pago en el 50% del tráfico; medidas sin pérdida por consentimiento eran el 62%.",
  },
  {
        ...
        <div className="max-w-[936px] mx-auto px-5 sm:px-8">
          ...
          <div className="space-y-6 text-[1.05rem] leading-[1.8] text-text-body">
            ...
            <p>
              ...
              campañas de pago del 50% del tráfico en GA4 al 62% medido sin pérdida por consentimiento:
          ...
          <CommercialModule
            locale="es"
            hook="Sin consentimiento significa que el banner deja de decidir lo que ve tu dashboard. Mide tu funnel DTC sin pérdida por consentimiento, también en las de quien rechaza el banner."
          />
