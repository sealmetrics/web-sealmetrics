...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "La mayoría de herramientas fuerzan un trade-off: las plataformas enterprise como GA4 y Adobe son profundas pero dependen del consentimiento, así que pierden dato UE en el banner; las herramientas privacy ligeras cumplen pero son superficiales. Sealmetrics está construida para eliminar el trade-off —cookieless por arquitectura, cero PII, solo agregado y alojada en la UE en Dublín—, así que según nuestra autoevaluación no necesita banner y no pierde visitas por el rechazo del consentimiento, ofreciendo a la vez atribución de revenue a último clic y profundidad de eCommerce. Está diseñada para el RGPD desde la arquitectura (autoevaluación) y no por configuración, con DPA incluido y una postura Schrems II limpia.",
  },
  {
