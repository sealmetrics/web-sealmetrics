...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Sealmetrics no almacena nada en el dispositivo del visitante ni trata dato personal. No hay cookies, ni localStorage, ni fingerprinting, ni retención de IP ni identificadores personales — la medición es agregada y anónima a nivel de evento. Como supera tanto el test de dispositivo de ePrivacy como el test de dato personal del RGPD, no se requiere legalmente ningún banner. El dato se aloja en Dublín (Irlanda), se incluye un DPA y la atribución es a último clic sobre tráfico sin huecos de consentimiento. Nota: Sealmetrics no reclama certificación ISO 27001 ni SOC 2; su caso de cumplimiento se apoya en la arquitectura — RGPD por diseño, ePrivacy y alojamiento UE limpio bajo Schrems II.",
  },
];
