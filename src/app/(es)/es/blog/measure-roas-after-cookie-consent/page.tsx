      ...
      <article className="pt-12 pb-28 bg-white">
        <div className="max-w-[936px] mx-auto px-5 sm:px-8">
          ...
          <p className="tldr mb-12 text-[1.15rem] leading-[1.7] text-text-secondary font-serif italic">
            ...
            otra con ingresos medidos en cada sesión y conciliados con tus pedidos
          ...
          <div className="key-takeaways mb-12 p-6 bg-warm-white border border-warm-100 rounded-[4px]">
            ...
            <ul className={`text-[0.9rem] leading-[1.7] text-text-secondary ${dashList}`}>
              ...
              <li>La pérdida es desigual. En la tienda Shopify de Incapto, GA4 situaba las campañas de pago en el 50% del tráfico; medidas en cada visita eran el 62%.</li>
          ...
          <div className="space-y-6 text-[1.05rem] leading-[1.8] text-text-body">
            ...
            <p>
              ...
              el 50% del tráfico en GA4 y el 62% medido en cada visita. Un ROAS de
          ...
          <CommercialModule
            locale="es"
            hook="¿Tres ROAS para una misma campaña? Medimos los ingresos en cada sesión, los conciliamos con tus pedidos y los ponemos junto al ROAS de tus plataformas."
          />
