...
const FAQ = [
  ...
  },
  {
    ...
    answer:
      "No. Sealmetrics no envía conversiones a las plataformas publicitarias, así que el píxel o la API de conversiones de Meta siguen alimentando sus pujas. Sealmetrics mide, en cada sesión, las conversiones y los ingresos de las visitas que llegaron desde anuncios de Meta, identificadas por sus UTM, y ese total es el que pones junto al CRM.",
  },
];
      ...
      <article className="pt-12 pb-28 bg-white">
        <div className="max-w-[936px] mx-auto px-5 sm:px-8">
          ...
          <p className="tldr mb-12 text-[1.15rem] leading-[1.7] text-text-secondary font-serif italic">
            ...
            cifra en medio: las conversiones medidas en tu web desde tráfico de Meta, en
            cada sesión.
          </p>
              ...
              <table className="w-full text-[0.95rem] border-collapse min-w-[640px]">
                <thead>
                  <tr>
                    ...
                    <th className={th}>Analítica web, cada sesión</th>
          ...
          <CommercialModule
            locale="es"
            hook="¿Meta dice una cifra y tu CRM otra? Medimos las conversiones del tráfico de Meta en cada sesión y las ponemos entre las dos, semana a semana."
          />
