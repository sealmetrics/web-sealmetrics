...
const SOCIAL =
  "Las plataformas evalúan sus propios anuncios y GA4 pierde a quien rechaza las cookies. Atribuye ingresos a campaña y creatividad sin pérdida por consentimiento.";
